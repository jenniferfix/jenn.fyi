...
export const ZodIcon = (props: React.ComponentProps<"svg">) => (
	<svg
	...
	>
		...
		<path
			fill="#18253F"
			d="M60.816 14.033h136.278l39.933 41.69-112.989 126.554L18.958 55.724z"
		/>
		<path
			fill="#274D82"
			d="M151.427 152.385H98.013L73.89 122.852l68.364-.002.002-4.19h39.078z"
		/>
		<path
			fill="#274D82"
